...
### **Visualisatie**
Bij Windigipet (https://youtu.be/sFBHR9UL41U?t=300) en Railware (https://youtu.be/aJ_4Dm8kwrU?t=25 ) wordt een visualisatie gegeven van een rijdende trein binnen één blok (dus zonder extra bezetmelders) door kleine railelementjes een andere kleur te geven (waarschijnlijk a.h.v. trein- en bloklengte). Bij Windigipet moeten de te visualiseren stukjes wel vooraf worden ingetekend. Bij RocRail (met betaalde sleutel) is het mogelijk om samen te werken met de betaalde versie van 3D Train Studio voor een 3D-visualisatie van de baan (https://www.youtube.com/watch?v=_4eGqkkhIzs)
