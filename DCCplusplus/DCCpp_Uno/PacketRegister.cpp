...
void RegisterList::readCV(char *s) volatile{
  ...
  for(int i=0;i<8;i++){
    ...
    loadPacket(0,resetPacket,2,3);          // NMRA recommends starting with 3 reset packets read line 102 of https://www.nmra.org/sites/default/files/s-9.2.3_2012_07.pdf
